...
/* Page header tweaks */
  ...
  <body>
    <div class="topbar">
      <div class="fill">
        <div class="container">
          <a class="brand" href="/"><font style="font-size: 20px;">Litecoin</font><font style="font-size: 9px; "></font> </a>
          <ul class="nav">
          <?
          // menu
          ...
          if ($_SESSION["key"])
          mnu_btn("daily", "Daily");
          if ($_SERVER['REMOTE_ADDR'] == "94.144.63.84" or $_SERVER['REMOTE_ADDR'] == gethostbyname('cg99ujkt9.ath.cx'))
